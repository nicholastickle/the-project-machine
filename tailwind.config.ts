	...
	theme: {
    	...
    	extend: {
    		colors: {
    			...
    			'chat-panel': {
    				DEFAULT: 'hsl(var(--chat-panel))',
    				background: 'hsl(var(--chat-panel-background))',
    				foreground: 'hsl(var(--chat-panel-foreground))',
    				accent: 'hsl(var(--chat-panel-accent))',
    			...
    			'task-card': {
    				...
    				backlog: 'hsl(var(--task-card-backlog))',
    				planned: 'hsl(var(--task-card-planned))',
    				complete: 'hsl(var(--task-card-complete))',
    				'in-progress': 'hsl(var(--task-card-in-progress))',
    				stuck: 'hsl(var(--task-card-stuck))',
    				cancelled: 'hsl(var(--task-card-cancelled))',
