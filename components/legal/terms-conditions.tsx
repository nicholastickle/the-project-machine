    ...
    return (
        <>
            <section id="terms-conditions" className="space-y-6">
                <div className="pb-4">
                    <h2 className="text-3xl font-semibold text-foreground">2. Terms & Conditions</h2>
                ...
                <div className="space-y-6 text-foreground">
                    ...
                    <div>
                        <h3 className="text-xl font-semibold mb-3">2.2. Use License</h3>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <div>
                        <h3 className="text-xl font-semibold mb-3">2.3. User Account</h3>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <div>
                        <h3 className="text-xl font-semibold mb-3">2.4. Service Availability</h3>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <div>
                        <h3 className="text-xl font-semibold mb-3">2.5. Limitation of Liability</h3>
                        <p className="text-muted-foreground leading-relaxed">
