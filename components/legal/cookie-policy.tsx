    ...
    return (
        <>
            <section id="cookie-policy" className="space-y-6">
                <div className="pb-4">
                    <h2 className="text-3xl font-semibold text-foreground">3. Cookie Policy</h2>
                    <p className="text-sm text-muted-foreground mt-2">Last updated: January 08, 2026</p>
                </div>

                <div className="space-y-6 text-foreground">
                    <div>
                        <h3 className="text-xl font-semibold mb-3">3.1. What Are Cookies</h3>
                    ...
                    <div>
                        <h3 className="text-xl font-semibold mb-3">3.2. How We Use Cookies</h3>
                        <p className="text-muted-foreground leading-relaxed">
                    ...
                    <div>
                        <h3 className="text-xl font-semibold mb-3">3.3. Types of Cookies We Use</h3>
                    ...
                    <div>
                        <h3 className="text-xl font-semibold mb-3">3.4. Managing Cookies</h3>
                        <p className="text-muted-foreground leading-relaxed">
