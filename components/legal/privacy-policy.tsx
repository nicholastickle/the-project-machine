        ...
        <>
            <AnimatedSection className="space-y-8" delay={0.3}>
                <section id="privacy-policy" className="space-y-6">
                    <div className="pb-4">
                        <h2 className="text-3xl font-semibold text-foreground">1. Privacy Policy</h2>
                        <p className="text-sm text-muted-foreground mt-2">Last updated: January 08, 2026</p>
                    </div>

                    <div className="space-y-6 text-foreground">
                        <div>
                            <h3 className="text-xl font-semibold mb-3">1.1. Information We Collect</h3>
                        ...
                        <div>
                            <h3 className="text-xl font-semibold mb-3">1.2. How We Use Your Information</h3>
                            <p className="text-muted-foreground leading-relaxed">
                        ...
                        <div>
                            <h3 className="text-xl font-semibold mb-3">1.3. Information Sharing</h3>
                            <p className="text-muted-foreground leading-relaxed">
                        ...
                        <div>
                            <h3 className="text-xl font-semibold mb-3">1.4. Data Security</h3>
                            <p className="text-muted-foreground leading-relaxed">
