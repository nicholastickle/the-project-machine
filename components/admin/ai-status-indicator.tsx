    ...
    return (
        <div className="fixed top-4 left-4 z-50">
            ...
            <button
                ...
                className="flex items-center gap-2 bg-gray-900 backdrop-blur-md text-white rounded-lg px-3 py-2 font-mono text-xs hover:bg-gray-800 transition-colors border border-gray-700 shadow-xl"
            >
            ...
            {/* Expanded Log Panel */}
            {isOpen && (
                <div className="mt-2 bg-gray-900 backdrop-blur-md text-white rounded-lg p-3 font-mono text-xs max-w-md border border-gray-700 shadow-2xl">
                    {/* Status Header */}
