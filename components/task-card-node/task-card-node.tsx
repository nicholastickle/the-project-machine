import TaskHandles from '@/components/task-card-node/task-card-handles';
import TaskCardTitle from '@/components/task-card-node/task-card-title';
import TaskCardStatus from '@/components/task-card-node/task-card-status';
import TaskCardDescription from '@/components/task-card-node/task-card-description';
import TaskCardSubtask from '@/components/task-card-node/task-card-subtask';
import TaskCardComments from '@/components/task-card-node/task-card-comments';
import TaskCardMembers from '@/components/task-card-node/task-card-members';
import TaskCardDurations from '@/components/task-card-node/task-card-durations';
import TaskCardOptionsBadge from '@/components/task-card-node/task-card-options-badge';
