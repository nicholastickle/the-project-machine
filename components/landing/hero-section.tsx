...
export default function HeroSection() {
  return (
    <div className="flex flex-row justify-center border border-border-dark ">
      ...
      <main
        className="flex-1 max-w-[1320px relative flex flex-col items-center text-center rounded-2xl overflow-hidden px-4 w-full h-[400px] sm:h-[450px] md:w-[98vw] md:h-[500px] lg:w-[98vw] lg:h-[600px] xl:w-[1220px] xl:h-[810px]  max-w-[1220px]"
        style={{
          '--primary': '25 95% 53%',
